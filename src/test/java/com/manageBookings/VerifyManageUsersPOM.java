...
import com.TMS.ObjectRepo.SignUpPage;
import com.TMS.ObjectRepo.UpdateProfilePage;
...
public class VerifyManageUsersPOM extends BaseClass{

@Test(groups = "Smoke")
public void verifyManageUsersPOM() throws InterruptedException, IOException {
		...
		HashMap<String, String> map = libE.getMultipleDataFromExcelByXpath("Sheet3", 0, 1, driver);
		SignUpPage sp=new SignUpPage(driver);
		sp.signUp(map, driver, email, actAcc);
	...
	/*	driver.findElement(By.xpath("(//input[@name='email'])[1]")).sendKeys(email);
		...
		libW.mouseHoverOnElement(driver, target);
