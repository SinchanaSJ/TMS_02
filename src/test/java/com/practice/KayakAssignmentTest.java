...
public class KayakAssignmentTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//driver.findElement(By.xpath("(//div[@class='k_my k_my-mod-theme-mcfly-search k_my-mod-radius-base k_my-mod-size-large k_my-mod-font-size-base k_my-mod-spacing-default k_my-mod-text-overflow-ellipsis k_my-mod-state-default'])[1]']")).sendKeys("Bengaluru");
